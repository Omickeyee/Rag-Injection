...
def train_LLM_defense(dataset, output_dir = None, num_epochs = 4, learning_rate = 2e-5, batch_size = 16, eval_split = 0.15, seed = 42):
    output_dir = output_dir or settings.model_output_dir / 'LLM_defense'
    ...
    LLMdefense = LLMDefense.from_pretrained(_DEFAULT_MODEL_NAME)
    tokenizer = LLMdefense._tokenizer
    model = LLMdefense._model
