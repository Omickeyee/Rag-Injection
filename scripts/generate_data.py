#!/usr/bin/env python3
"""Generate synthetic enterprise corpus with injected attack payloads.

Produces:
  - data/generated/corpus.json   — full document corpus (clean + poisoned)
  - data/generated/manifest.json — ground-truth record of every injection
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        type=int,
        default=None,
        help="Total clean docs to generate (default: from settings)",
    )
...
def main() -> None:
    ...
    # Proportional split: 30% confluence, 30% slack, 20% email, 20% internal_docs
